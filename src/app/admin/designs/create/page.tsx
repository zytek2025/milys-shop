...
export default function AdminDesignCreatePage() {
    ...
    const handleSaveDesign = async () => {
        ...
        try {
            ...
            toast.success("Diseño guardado en la colección administrativa");
        ...
        <div className="flex flex-col gap-6">
            <div className="flex items-center gap-4">
                <Button variant="ghost" asChild>
                    <Link href="/admin/designs"><ArrowLeft className="mr-2" size={18} /> Volver a Colección</Link>
                </Button>
                <h1 className="text-2xl font-black italic tracking-tighter uppercase text-slate-800 dark:text-white">Admin Studio <span className="text-primary">// Canva Integration</span></h1>
            </div>
            ...
            <Card className="border-none shadow-2xl bg-white dark:bg-slate-900 rounded-[2rem] overflow-hidden">
                <div className="bg-gradient-to-r from-purple-600 via-pink-600 to-rose-600 p-1 text-center">
                    <span className="text-[10px] font-black uppercase tracking-[0.3em] text-white">Admin Design Tool</span>
                </div>
                    ...
                    {!designUrl ? (
                        isDesigning ? (
                            <div className="space-y-6 animate-pulse">
                                ...
                                <p className="text-slate-500">Conectando con Canva para crear recursos gráficos.</p>
                            </div>
                        ) : (
                            <div className="space-y-8 max-w-lg mx-auto">
                                ...
                                <div>
                                    <h1 className="text-5xl font-black tracking-tighter text-slate-900 dark:text-white mb-4 italic">Crear Nuevo Diseño</h1>
                                    <p className="text-lg text-slate-500 font-medium leading-relaxed">
                                        Genera logos, banners y recursos gráficos para los productos de la tienda usando Canva.
                                    </p>
                                </div>
                                ...
                                >
                                    <span className="flex items-center gap-3">
                                        Iniciar Canva <ExternalLink size={20} />
                                    </span>
                                </Button>
                                <p className="text-xs text-slate-400 uppercase tracking-widest font-bold">Cuenta: {USER_EMAIL}</p>
                            </div>
                        )
                    ) : (
                        <div className="w-full space-y-8 animate-in fade-in slide-in-from-bottom-10 duration-700">
                            <div className="flex flex-col items-center gap-4">
                                ...
                                <p className="text-slate-500 max-w-md mx-auto">El diseño se ha generado correctamente.</p>
                            </div>
                            ...
                            <div className="flex justify-center gap-4">
                                ...
                                >
                                    {saving ? <Loader2 className="mr-2 h-4 w-4 animate-spin" /> : 'Guardar en Colección'}
                                </Button>
                            </div>
                        </div>
                    )}
